        ...
        <nx-container>
            <nx-section>
                <nx-section-header>
                    ...
                    <template slot="subtitle"> Welcome back, Saugi! </template>
                </nx-section-header>
                <div class="flex row">
                                ...
                                <div class="flex row items-center">
                                    ...
                                    <div class="w-1/2 col">
                                        ...
                                        <p class="text-sm">
                                            ...
                                            adipisicing elit. Molestias, dolor fugit
                                            distinctio quod, nobis in
                                        </p>
                                    </div>
                                </div>
                            </template>
